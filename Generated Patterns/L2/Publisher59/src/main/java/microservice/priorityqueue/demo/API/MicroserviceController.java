...
@RequestMapping("api/v1/Publisher59")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:11962/api/Bus117)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:11964/api/Bus118)
