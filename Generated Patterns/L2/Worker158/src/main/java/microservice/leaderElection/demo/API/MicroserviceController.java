...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:12086/api/Worker157/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response8 = restTemplate.exchange(http://localhost:12086/api/Worker157/post,HTTP.POST,entity,String.class)
return null ;
