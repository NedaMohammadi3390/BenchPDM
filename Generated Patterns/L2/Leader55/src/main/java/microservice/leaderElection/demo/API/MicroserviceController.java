...
@RequestMapping("api/v1/Leader55")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:12076/api/Worker149/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:12076/api/Worker149/post,HTTP.POST,entity,String.class)
