...
@RequestMapping("api/v1/Publisher47")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9631/api/Bus89)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9633/api/Bus90)
