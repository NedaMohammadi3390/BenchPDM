...
@RequestMapping("api/v1/Leader36")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10432/api/Worker107/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:10433/api/Worker108/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:10432/api/Worker107/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response7 = restTemplate.exchange(http://localhost:10433/api/Worker108/post,HTTP.POST,entity,String.class)
