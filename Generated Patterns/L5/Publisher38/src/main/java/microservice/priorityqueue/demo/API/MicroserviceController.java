...
@RequestMapping("api/v1/Publisher38")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9582/api/Bus74)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9584/api/Bus75)
