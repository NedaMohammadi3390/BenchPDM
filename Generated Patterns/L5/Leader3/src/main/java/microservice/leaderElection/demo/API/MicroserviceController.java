...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10301/api/Worker9/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:10301/api/Worker9/post,HTTP.POST,entity,String.class)
