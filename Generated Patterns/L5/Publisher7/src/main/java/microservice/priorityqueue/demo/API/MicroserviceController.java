...
@RequestMapping("api/v1/Publisher7")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9406/api/Bus11)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9408/api/Bus12)
