...
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:10350/api/Worker47/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10350/api/Worker47/post,HTTP.POST,entity,String.class)
return null ;
