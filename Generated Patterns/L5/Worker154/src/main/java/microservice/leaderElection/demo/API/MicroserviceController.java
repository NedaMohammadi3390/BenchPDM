...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:10490/api/Worker152/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10491/api/Worker153/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response7 = restTemplate.exchange(http://localhost:10490/api/Worker152/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response8 = restTemplate.exchange(http://localhost:10491/api/Worker153/post,HTTP.POST,entity,String.class)
return null ;
