...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9449/api/Bus26)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9451/api/Bus27)
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:9453/api/Bus28)
