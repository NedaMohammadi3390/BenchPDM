...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10316/api/Worker21/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:10316/api/Worker21/post,HTTP.POST,entity,String.class)
