...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10341/api/Worker41/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:10342/api/Worker42/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response9 = restTemplate.exchange(http://localhost:10341/api/Worker41/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response10 = restTemplate.exchange(http://localhost:10342/api/Worker42/post,HTTP.POST,entity,String.class)
return null ;
