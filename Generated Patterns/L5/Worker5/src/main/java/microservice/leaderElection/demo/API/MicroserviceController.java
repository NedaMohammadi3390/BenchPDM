...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10293/api/Worker3/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:10294/api/Worker4/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response9 = restTemplate.exchange(http://localhost:10293/api/Worker3/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response10 = restTemplate.exchange(http://localhost:10294/api/Worker4/post,HTTP.POST,entity,String.class)
return null ;
