...
@RequestMapping("api/v1/Leader28")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10400/api/Worker83/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:10401/api/Worker84/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:10400/api/Worker83/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response7 = restTemplate.exchange(http://localhost:10401/api/Worker84/post,HTTP.POST,entity,String.class)
