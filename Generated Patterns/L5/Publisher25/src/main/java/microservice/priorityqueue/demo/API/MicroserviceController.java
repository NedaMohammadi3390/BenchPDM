...
@RequestMapping("api/v1/Publisher25")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9502/api/Bus45)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9504/api/Bus46)
