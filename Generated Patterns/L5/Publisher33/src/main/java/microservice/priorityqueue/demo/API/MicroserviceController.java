...
@RequestMapping("api/v1/Publisher33")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9551/api/Bus64)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9553/api/Bus65)
