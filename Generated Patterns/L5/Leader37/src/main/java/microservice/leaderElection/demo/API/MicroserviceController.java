...
@RequestMapping("api/v1/Leader37")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10438/api/Worker112/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:10439/api/Worker113/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:10438/api/Worker112/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response7 = restTemplate.exchange(http://localhost:10439/api/Worker113/post,HTTP.POST,entity,String.class)
