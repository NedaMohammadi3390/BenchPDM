...
@RequestMapping("api/v1/Leader49")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10489/api/Worker151/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:10490/api/Worker152/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:10489/api/Worker151/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:10490/api/Worker152/post,HTTP.POST,entity,String.class)
