...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10372/api/Worker62/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:10372/api/Worker62/post,HTTP.POST,entity,String.class)
