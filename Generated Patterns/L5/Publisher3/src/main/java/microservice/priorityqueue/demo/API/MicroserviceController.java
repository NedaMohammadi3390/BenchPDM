...
@RequestMapping("api/v1/Publisher3")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9385/api/Bus5)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9387/api/Bus6)
