...
@RequestMapping("api/v1/Leader30")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10411/api/Worker92/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10411/api/Worker92/post,HTTP.POST,entity,String.class)
