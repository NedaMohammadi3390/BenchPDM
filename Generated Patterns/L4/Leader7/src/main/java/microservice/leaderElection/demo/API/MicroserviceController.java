...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9712/api/Worker19/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:9712/api/Worker19/post,HTTP.POST,entity,String.class)
