...
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9701/api/Worker11/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:9700/api/Leader4/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:9701/api/Worker11/post,HTTP.POST,entity,String.class)
return null ;
