...
@RequestMapping("api/v1/Leader21")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9766/api/Worker59/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9767/api/Worker60/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:9766/api/Worker59/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:9767/api/Worker60/post,HTTP.POST,entity,String.class)
