...
@RequestMapping("api/v1/Publisher5")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9202/api/Bus9)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9204/api/Bus10)
