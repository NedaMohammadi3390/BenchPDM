...
@RequestMapping("api/v1/Publisher1")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9182/api/Bus2)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9184/api/Bus3)
