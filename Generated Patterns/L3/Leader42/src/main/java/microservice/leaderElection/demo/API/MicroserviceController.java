...
@RequestMapping("api/v1/Leader42")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:11529/api/Worker114/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:11530/api/Worker115/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:11529/api/Worker114/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:11530/api/Worker115/post,HTTP.POST,entity,String.class)
