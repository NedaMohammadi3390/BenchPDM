...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:11555/api/Worker133/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:11555/api/Worker133/post,HTTP.POST,entity,String.class)
return null ;
