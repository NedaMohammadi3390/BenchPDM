...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:11530/api/Worker115/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:11531/api/Worker116/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response7 = restTemplate.exchange(http://localhost:11530/api/Worker115/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response8 = restTemplate.exchange(http://localhost:11531/api/Worker116/post,HTTP.POST,entity,String.class)
return null ;
