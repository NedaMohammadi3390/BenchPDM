...
@RequestMapping("api/v1/Publisher43")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:11214/api/Bus84)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:11216/api/Bus85)
