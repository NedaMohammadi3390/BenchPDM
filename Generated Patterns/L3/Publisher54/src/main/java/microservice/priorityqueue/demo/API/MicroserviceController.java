...
@RequestMapping("api/v1/Publisher54")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:11279/api/Bus107)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:11281/api/Bus108)
