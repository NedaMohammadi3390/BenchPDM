...
ResponseEntity<String> response7 = restTemplate.exchange(http://localhost:11508/api/Client125/get,HTTP.GET,entity,String.class)
ResponseEntity<String> response8 = restTemplate.exchange(http://localhost:11512/api/Client126/get,HTTP.GET,entity,String.class)
ResponseEntity<String> response9 = restTemplate.exchange(http://localhost:11515/api/Client127/get,HTTP.GET,entity,String.class)
ResponseEntity<String> response10 = restTemplate.exchange(http://localhost:11516/api/Client128/get,HTTP.GET,entity,String.class)
ResponseEntity<String> response11 = restTemplate.exchange(http://localhost:11519/api/Client129/get,HTTP.GET,entity,String.class)
ResponseEntity<String> response12 = restTemplate.exchange(http://localhost:11520/api/Client130/get,HTTP.GET,entity,String.class)
return null ;
