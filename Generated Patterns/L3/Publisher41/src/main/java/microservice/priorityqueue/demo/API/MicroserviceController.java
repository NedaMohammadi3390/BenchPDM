...
@RequestMapping("api/v1/Publisher41")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:11202/api/Bus79)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:11204/api/Bus80)
