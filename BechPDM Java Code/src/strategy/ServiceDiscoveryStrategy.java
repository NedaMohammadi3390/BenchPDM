...
public class ServiceDiscoveryStrategy extends Strategy {
    ...
    public static int loadBalanceCounter = 0;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public Builder fileFiller(String role, String microserviceName, String[] connections, Pair<Microservice.ConnectionType, String>[] connectionTypes) {
        ...
        switch (role) {
            case "Client":
                ...
                break;
            case "LoadBalancer":
                builder = loadBalancerClass(microserviceName, connections);
                setMethodsLoadBalancer(builder);
                break;
            case "ServiceRegistry":
                builder = workerClass(microserviceName, connections);
                setMethodsServiceRegistry(builder);
                break;
            case "Worker":
                builder = workerClass(microserviceName, connections);
    ...
    private Builder loadBalancerClass(String microserviceName, String[] connections) {
        return new Builder("microservice." + "servicediscovery" + ".demo.API")
                .setContent(
                        new ClassGenerator(
                                Constants.AccessLevel.PUBLIC,
    ...
    private void setMethodsLoadBalancer(Builder builder) {
        setMethodContent(
                builder,
                Constants.AccessLevel.PUBLIC,
                false,
                false,
                new Pair(Constants.ReturnType.INT, "getServiceAddress"),
                new Pair[]{
                        new Pair<>(Constants.VariableTypeRequestBody.String, "info")
                },
                new Pair[]{
                        new Pair(Constants.Annotations.GetMapping, "/getting-info_service")
                },
        ...
        setMethodContent(
                ...
                false,
                false,
                new Pair(Constants.ReturnType.INT, "createService"),
                new Pair[]{
                        new Pair<>(Constants.VariableTypeRequestBody.String, "info")
                },
                new Pair[]{
                        new Pair(Constants.Annotations.PostMapping, "/creating-info-service")
                },
                Constants.Keywords.NULL.toString(),
                Postlist
        );
        setMethodContent(
                ...
                false,
                false,
                new Pair(Constants.ReturnType.INT, "updatingService"),
                new Pair[]{
                        new Pair<>(Constants.VariableTypeRequestBody.String, "info")
                },
                new Pair[]{
                        new Pair(Constants.Annotations.PutMapping, "/updating-info-service")
                },
                Constants.Keywords.NULL.toString(),
                Putlist
        );
        setMethodContent(
                ...
                false,
                false,
                new Pair(Constants.ReturnType.INT, "deletingService"),
                new Pair[]{
                        new Pair<>(Constants.VariableTypeRequestBody.String, "Id")
                },
                new Pair[]{
                        new Pair(Constants.Annotations.DeleteMapping, "/deleting-info-service")
                },
                Constants.Keywords.NULL.toString(),
                Deletelist
        );
    ...
    private Builder serviceRegistryClass(String microserviceName, String[] connections) {
        return new Builder("microservice." + "serviceDiscovery" + ".demo.API")
                .setContent(
                        new ClassGenerator(
                                Constants.AccessLevel.PUBLIC,
    ...
    private void setMethodsServiceRegistry(Builder builder) {
        setMethodContent(
                builder,
                Constants.AccessLevel.PUBLIC,
                false,
