...
public class ZuulGeneration extends Builder implements TemplateGenerator, IGenerate {
    ...
    public ZuulGeneration(String applicationName, String path, String folderTpl, String packageName, String strpkname) {
    ...
    public String generate() throws IOException {
        tmG.generate("ZuulApplication.java","Application");
        return null;
    }
