...
public class EurekaGeneration extends Builder implements TemplateGenerator, IGenerate {
    ...
    public EurekaGeneration(String applicationName, String path, String folderTpl, String packageName, String strpkname) {
    ...
    public String generate() throws IOException {
        tmG.generate("EurekaServer.java","Application");
        return null;
    }
