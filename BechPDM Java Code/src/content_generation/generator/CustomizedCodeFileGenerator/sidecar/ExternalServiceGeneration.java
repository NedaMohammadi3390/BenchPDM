...
public class ExternalServiceGeneration extends Builder implements TemplateGenerator, IGenerate {
    ...
    public ExternalServiceGeneration(String applicationName, String path, String folderTpl, String packageName, String strpkname) {
    ...
    public String generate() throws IOException {
        tmG.generate("ExternalServiceApplication.java","Application");
        tmG.generate("ExternalServiceController.java","Controller");
        return null;
    }
