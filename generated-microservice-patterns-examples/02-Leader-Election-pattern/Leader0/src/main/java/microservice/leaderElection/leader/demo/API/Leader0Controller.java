...
@RestController
@RequestMapping("/Leader0Controller")
public class Leader0ControllerController {
...
public Leader0ControllerController(ManagerContext managerContext) throws UnknownHostException {
