...
@RequestMapping("api/v1/Publisher45")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:11226/api/Bus89)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:11228/api/Bus90)
