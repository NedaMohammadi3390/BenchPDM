...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:11881/api/Client146/get,HTTP.GET,entity,String.class)
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:11883/api/Client147/get,HTTP.GET,entity,String.class)
return null ;
