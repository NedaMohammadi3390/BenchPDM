...
@RequestMapping("api/v1/Publisher50")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:11257/api/Bus100)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:11259/api/Bus101)
