...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10325/api/Worker28/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:10326/api/Worker29/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response9 = restTemplate.exchange(http://localhost:10325/api/Worker28/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response10 = restTemplate.exchange(http://localhost:10326/api/Worker29/post,HTTP.POST,entity,String.class)
return null ;
