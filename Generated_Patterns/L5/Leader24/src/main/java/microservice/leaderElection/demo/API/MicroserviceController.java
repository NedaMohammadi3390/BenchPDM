...
@RequestMapping("api/v1/Leader24")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10383/api/Worker70/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:10383/api/Worker70/post,HTTP.POST,entity,String.class)
