...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10355/api/Worker50/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:10355/api/Worker50/post,HTTP.POST,entity,String.class)
