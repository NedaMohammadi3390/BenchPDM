...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10368/api/Worker59/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10368/api/Worker59/post,HTTP.POST,entity,String.class)
