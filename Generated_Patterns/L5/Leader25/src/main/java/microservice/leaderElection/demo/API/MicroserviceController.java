...
@RequestMapping("api/v1/Leader25")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10389/api/Worker75/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:10389/api/Worker75/post,HTTP.POST,entity,String.class)
