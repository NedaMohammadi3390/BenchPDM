...
@RequestMapping("api/v1/Publisher29")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9526/api/Bus55)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9528/api/Bus56)
