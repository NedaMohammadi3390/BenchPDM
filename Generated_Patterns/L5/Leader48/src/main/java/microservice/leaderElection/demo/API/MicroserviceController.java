...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10485/api/Worker148/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10485/api/Worker148/post,HTTP.POST,entity,String.class)
