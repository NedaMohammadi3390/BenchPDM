...
@RequestMapping("api/v1/Leader27")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10397/api/Worker81/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:10397/api/Worker81/post,HTTP.POST,entity,String.class)
