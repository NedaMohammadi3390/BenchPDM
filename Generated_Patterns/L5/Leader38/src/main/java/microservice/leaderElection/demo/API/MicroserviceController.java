...
@RequestMapping("api/v1/Leader38")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10444/api/Worker117/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:10444/api/Worker117/post,HTTP.POST,entity,String.class)
