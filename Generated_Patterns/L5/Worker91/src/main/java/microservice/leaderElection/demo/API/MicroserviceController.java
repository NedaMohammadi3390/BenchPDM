...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10408/api/Worker90/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response8 = restTemplate.exchange(http://localhost:10408/api/Worker90/post,HTTP.POST,entity,String.class)
return null ;
