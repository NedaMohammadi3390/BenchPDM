...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10350/api/Worker47/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:10350/api/Worker47/post,HTTP.POST,entity,String.class)
