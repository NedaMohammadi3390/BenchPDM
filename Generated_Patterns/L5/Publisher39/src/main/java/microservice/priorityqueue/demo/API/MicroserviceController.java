...
@RequestMapping("api/v1/Publisher39")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9587/api/Bus76)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9589/api/Bus77)
