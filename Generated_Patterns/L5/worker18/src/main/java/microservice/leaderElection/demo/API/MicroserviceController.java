...
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:10310/api/Worker17/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response10 = restTemplate.exchange(http://localhost:10310/api/Worker17/post,HTTP.POST,entity,String.class)
return null ;
