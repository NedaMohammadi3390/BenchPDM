...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:10320/api/Worker24/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:10320/api/Worker24/post,HTTP.POST,entity,String.class)
return null ;
