...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:10461/api/Worker130/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:10461/api/Worker130/post,HTTP.POST,entity,String.class)
