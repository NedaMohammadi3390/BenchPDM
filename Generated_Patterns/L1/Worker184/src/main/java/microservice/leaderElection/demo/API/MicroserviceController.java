...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:12352/api/Worker183/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response8 = restTemplate.exchange(http://localhost:12352/api/Worker183/post,HTTP.POST,entity,String.class)
return null ;
