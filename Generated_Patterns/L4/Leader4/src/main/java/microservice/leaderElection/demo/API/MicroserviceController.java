...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9701/api/Worker11/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:9701/api/Worker11/post,HTTP.POST,entity,String.class)
