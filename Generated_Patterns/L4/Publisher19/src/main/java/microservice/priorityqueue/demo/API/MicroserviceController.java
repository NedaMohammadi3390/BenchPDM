...
@RequestMapping("api/v1/Publisher19")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9285/api/Bus39)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9287/api/Bus40)
