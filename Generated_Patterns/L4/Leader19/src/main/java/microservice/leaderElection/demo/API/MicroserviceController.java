...
@RequestMapping("api/v1/Leader19")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9758/api/Worker53/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9759/api/Worker54/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:9758/api/Worker53/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response6 = restTemplate.exchange(http://localhost:9759/api/Worker54/post,HTTP.POST,entity,String.class)
