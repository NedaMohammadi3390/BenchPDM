...
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:9777/api/Worker68/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response10 = restTemplate.exchange(http://localhost:9777/api/Worker68/post,HTTP.POST,entity,String.class)
return null ;
