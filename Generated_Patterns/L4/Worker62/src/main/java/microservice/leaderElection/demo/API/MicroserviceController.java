...
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:9767/api/Worker60/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:9768/api/Worker61/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response7 = restTemplate.exchange(http://localhost:9767/api/Worker60/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response8 = restTemplate.exchange(http://localhost:9768/api/Worker61/post,HTTP.POST,entity,String.class)
return null ;
