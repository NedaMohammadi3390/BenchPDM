...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9780/api/Worker70/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:9780/api/Worker70/post,HTTP.POST,entity,String.class)
