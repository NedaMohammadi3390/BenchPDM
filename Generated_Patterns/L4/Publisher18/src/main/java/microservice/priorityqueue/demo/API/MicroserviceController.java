...
@RequestMapping("api/v1/Publisher18")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:9280/api/Bus37)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:9282/api/Bus38)
