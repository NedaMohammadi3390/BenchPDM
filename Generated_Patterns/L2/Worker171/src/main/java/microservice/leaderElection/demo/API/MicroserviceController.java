...
ResponseEntity<String> response4 = restTemplate.exchange(http://localhost:12101/api/Worker169/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response5 = restTemplate.exchange(http://localhost:12102/api/Worker170/post,HTTP.POST,entity,String.class)
...
ResponseEntity<String> response9 = restTemplate.exchange(http://localhost:12101/api/Worker169/post,HTTP.POST,entity,String.class)
ResponseEntity<String> response10 = restTemplate.exchange(http://localhost:12102/api/Worker170/post,HTTP.POST,entity,String.class)
return null ;
