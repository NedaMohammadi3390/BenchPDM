...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:11978/api/worker178/put,HTTP.PUT,entity,String.class)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:11979/api/worker179/put,HTTP.PUT,entity,String.class)
ResponseEntity<String> response3 = restTemplate.exchange(http://localhost:11982/api/worker180/put,HTTP.PUT,entity,String.class)
return null ;
