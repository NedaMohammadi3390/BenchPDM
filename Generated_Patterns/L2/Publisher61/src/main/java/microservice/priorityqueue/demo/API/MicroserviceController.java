...
@RequestMapping("api/v1/Publisher61")
@RestController
...
ResponseEntity<String> response1 = restTemplate.exchange(http://localhost:11974/api/Bus122)
ResponseEntity<String> response2 = restTemplate.exchange(http://localhost:11976/api/Bus123)
