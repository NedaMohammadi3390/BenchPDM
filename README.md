...
## Application of BenchPDM
  **BenchPDM**  is a benchmark for pattern-assisted microservice-based system (PAMBS) consisting of two important modules **PBMC** and **PDM-ES**.
  To support PDMs that accommodate programming languages other than Java, the benchmark provides output in three types, generated code of a PAMBS, dependency graph for the PAMBS in an XML format, and tracing information of the MS within the 
