...
@RestController
@RequestMapping("/Leader24Controller")
public class Leader24ControllerController {
...
public Leader24ControllerController(ManagerContext managerContext) throws UnknownHostException {
