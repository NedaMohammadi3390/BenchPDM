...
@RestController
@RequestMapping("/Leader7Controller")
public class Leader7ControllerController {
...
public Leader7ControllerController(ManagerContext managerContext) throws UnknownHostException {
