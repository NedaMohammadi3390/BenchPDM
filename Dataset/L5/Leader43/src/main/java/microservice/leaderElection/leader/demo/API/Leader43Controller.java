...
@RestController
@RequestMapping("/Leader43Controller")
public class Leader43ControllerController {
...
public Leader43ControllerController(ManagerContext managerContext) throws UnknownHostException {
