...
@RestController
@RequestMapping("/Leader30Controller")
public class Leader30ControllerController {
...
public Leader30ControllerController(ManagerContext managerContext) throws UnknownHostException {
