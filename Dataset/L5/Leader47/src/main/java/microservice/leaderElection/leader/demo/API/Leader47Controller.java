...
@RestController
@RequestMapping("/Leader47Controller")
public class Leader47ControllerController {
...
public Leader47ControllerController(ManagerContext managerContext) throws UnknownHostException {
