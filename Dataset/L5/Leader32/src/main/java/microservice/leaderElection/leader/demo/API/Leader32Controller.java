...
@RestController
@RequestMapping("/Leader32Controller")
public class Leader32ControllerController {
...
public Leader32ControllerController(ManagerContext managerContext) throws UnknownHostException {
