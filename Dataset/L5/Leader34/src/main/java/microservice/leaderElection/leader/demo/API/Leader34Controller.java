...
@RestController
@RequestMapping("/Leader34Controller")
public class Leader34ControllerController {
...
public Leader34ControllerController(ManagerContext managerContext) throws UnknownHostException {
