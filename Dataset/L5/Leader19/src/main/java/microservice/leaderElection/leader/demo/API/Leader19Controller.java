...
@RestController
@RequestMapping("/Leader19Controller")
public class Leader19ControllerController {
...
public Leader19ControllerController(ManagerContext managerContext) throws UnknownHostException {
