...
@RestController
@RequestMapping("/Leader42Controller")
public class Leader42ControllerController {
...
public Leader42ControllerController(ManagerContext managerContext) throws UnknownHostException {
