...
@RestController
@RequestMapping("/Leader6Controller")
public class Leader6ControllerController {
...
public Leader6ControllerController(ManagerContext managerContext) throws UnknownHostException {
