...
@RestController
@RequestMapping("/Leader27Controller")
public class Leader27ControllerController {
...
public Leader27ControllerController(ManagerContext managerContext) throws UnknownHostException {
