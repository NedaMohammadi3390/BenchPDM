...
@RestController
@RequestMapping("/Leader26Controller")
public class Leader26ControllerController {
...
public Leader26ControllerController(ManagerContext managerContext) throws UnknownHostException {
