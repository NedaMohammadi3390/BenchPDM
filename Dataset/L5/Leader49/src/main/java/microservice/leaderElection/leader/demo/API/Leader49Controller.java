...
@RestController
@RequestMapping("/Leader49Controller")
public class Leader49ControllerController {
...
public Leader49ControllerController(ManagerContext managerContext) throws UnknownHostException {
