...
@RestController
@RequestMapping("/Leader48Controller")
public class Leader48ControllerController {
...
public Leader48ControllerController(ManagerContext managerContext) throws UnknownHostException {
