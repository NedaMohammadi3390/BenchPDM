...
return new ServiceInstanceListSupplier() {
    ...
    public Flux<List<ServiceInstance>> get() {
        return Flux.just(Arrays.asList(
                        ...
                        new DefaultServiceInstance("provider5", "provider-service", "localhost", 9018, false),
                        new DefaultServiceInstance("provider6", "provider-service", "localhost", 9019, false),
                        new DefaultServiceInstance("provider7", "provider-service", "localhost", 9021, false),
                        new DefaultServiceInstance("provider8", "provider-service", "localhost", 9022, false),
                        new DefaultServiceInstance("provider9", "provider-service", "localhost", 9023, false),
                        new DefaultServiceInstance("provider10", "provider-service", "localhost", 9024, false),
                        ...
                        new DefaultServiceInstance("provider13", "provider-service", "localhost", 9028, false),
                        new DefaultServiceInstance("provider14", "provider-service", "localhost", 9029, false),
                        new DefaultServiceInstance("provider15", "provider-service", "localhost", 9030, false),
                        new DefaultServiceInstance("provider16", "provider-service", "localhost", 9031, false),
                        new DefaultServiceInstance("provider17", "provider-service", "localhost", 9033, false),
                        ...
                        new DefaultServiceInstance("provider20", "provider-service", "localhost", 9037, false),
