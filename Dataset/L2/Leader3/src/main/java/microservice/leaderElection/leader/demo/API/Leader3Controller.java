...
@RestController
@RequestMapping("/Leader3Controller")
public class Leader3ControllerController {
...
public Leader3ControllerController(ManagerContext managerContext) throws UnknownHostException {
