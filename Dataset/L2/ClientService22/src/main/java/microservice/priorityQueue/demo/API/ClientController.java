...
public class ClientController {
    ...
    public ClientService22Controller(RestTemplate restTemplate) {
    ...
    public String sendTask(@RequestParam String data, @RequestParam int priority) {
        String dispatcherUrl = "http://localhost:9088/dispatcher/add?data=" + data + "&priority=" + priority;
    ...
    public String triggerDispatch() {
        String dispatcherUrl = "http://localhost:9088/dispatcher/dispatch";
        ResponseEntity<String> response = restTemplate.postForEntity(dispatcherUrl, null, String.class);
