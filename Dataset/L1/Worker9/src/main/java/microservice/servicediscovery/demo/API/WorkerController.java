...
ResponseEntity<String> response4= restTemplate.exchange(http://localhost:9094/api/ServiceRegistry0/get,HTTP.GET,entity,String.class)
return null ;
...
ResponseEntity<String> response2= restTemplate.exchange(http://localhost:9094/api/ServiceRegistry0/delete,HTTP.DELETE,entity,String.class)
return null ;
