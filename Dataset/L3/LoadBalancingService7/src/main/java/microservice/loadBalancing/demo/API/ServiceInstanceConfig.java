...
return new ServiceInstanceListSupplier() {
    ...
    public Flux<List<ServiceInstance>> get() {
        return Flux.just(Arrays.asList(
                        ...
                        new DefaultServiceInstance("provider40", "provider-service", "localhost", 9061, false),
                        new DefaultServiceInstance("provider41", "provider-service", "localhost", 9062, false),
                        ...
                        new DefaultServiceInstance("provider44", "provider-service", "localhost", 9065, false),
                        ...
                        new DefaultServiceInstance("provider47", "provider-service", "localhost", 9069, false),
                        new DefaultServiceInstance("provider48", "provider-service", "localhost", 9070, false),
                        new DefaultServiceInstance("provider49", "provider-service", "localhost", 9071, false),
                        ...
                        new DefaultServiceInstance("provider52", "provider-service", "localhost", 9076, false),
                        ...
                        new DefaultServiceInstance("provider57", "provider-service", "localhost", 9082, false),
                        new DefaultServiceInstance("provider58", "provider-service", "localhost", 9083, false),
                        new DefaultServiceInstance("provider59", "provider-service", "localhost", 9084, false),
                        new DefaultServiceInstance("provider60", "provider-service", "localhost", 9085, false)
        ));
    }
}; 
return null ;
