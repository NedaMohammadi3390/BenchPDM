...
@RestController
@RequestMapping("/Leader10Controller")
public class Leader10ControllerController {
...
public Leader10ControllerController(ManagerContext managerContext) throws UnknownHostException {
