...
@RestController
@RequestMapping("/Leader4Controller")
public class Leader4ControllerController {
...
public Leader4ControllerController(ManagerContext managerContext) throws UnknownHostException {
